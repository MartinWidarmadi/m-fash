...
import { SignInContainer, SignInSubTitle, Buttons } from './sign-in-form.style.jsx';
...
const SignInForm = () => {
  ...
  return (
    <SignInContainer>
      <SignInSubTitle>I already have an account</SignInSubTitle>
      ...
      <form onSubmit={submitHandler}>
        ...
        <Buttons>
          ...
          <Button type="button" buttonType={BUTTON_TYPE_CLASSES.google} onClick={googleSignInHandler}>
            GOOGLE SIGN IN
          </Button>
        </Buttons>
      </form>
